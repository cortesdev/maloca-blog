...
export const Featured = () => {
    return (
        <section className="mx-auto w-full md:px-6 h-full flex   ">
            <div className="text-center flex flex-col my-32 w-full">
                ...
                <div className="mx-auto block md:flex gap-x-6 lg:gap-x-12">
                    <div className="mb-12 lg:mb-0">
                        <div className="mb-6 inline-block rounded-full bg-primary-100 p-4 text-primary shadow-sm">
                            <div className="featured-img flex items-center align-center justify-center w-20 h-20" >
                        ...
                        <p className="text-neutral-200 block xs:max-w-[300px] lg:max-w-[100%]">
